...
class ForgetPasswordViewController: UIViewController,UITextFieldDelegate {
    ...
    if (self.textFieldEmail.text != ""){
                showDefaultAlertViewWith(alertTitle:"something went wrong", alertMessage: fetusers[0].password, okTitle: Localizator.instance.localize(string: "Key_ok"), currentViewController: self)
        }
